...
<title>DANH SÁCH CHI NHÁNH - TRÀ SỮA</title>
<link
	...
	<div id="layoutSidenav_content">
		<main>
			<div class="container-fluid px-4">
				<h1 class="mt-4">DANH SÁCH CHI NHÁNH - TRÀ SỮA</h1>
				<ol class="breadcrumb mb-4">
					<li class="breadcrumb-item"><a style="text-decoration: none"
						href="/admin/index">Trang chủ</a></li>
					<li class="breadcrumb-item active"><a
						style="text-decoration: none; color: black"
						href="#">DANH SÁCH CHI NHÁNH - TRÀ SỮA</a></li>
				</ol>
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-table me-1"></i>BẢNG DANH SÁCH CHI NHÁNH - TRÀ SỮA
...
svg {
	fill: #e8e8e8
						...
						<button class="btn btn-success" onclick="exportToWordShares()"
							style="margin-left: 15px">
							<svg xmlns="http://www.w3.org/2000/svg" height="1em"
								viewBox="0 0 384 512">
										<style>
	...
	fill: #e8e8e8
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<c:forEach var="branchMilkTea" items="${branchMilkTeas}">
									<tr>
										<td>${branchMilkTea.branchMilkTeaId.idBranch}</td>
										<td>${branchMilkTea.branchMilkTeaId.idMilkTea}</td>
										<td>${branchMilkTea.branchMilkTeaId.size}</td>
										<td>${branchMilkTea.remainQuantity}</td>
										<td><a class="btn btn-success"
											href="/admin/branch-milk-tea/edit/${branchMilkTea.branchMilkTeaId.idBranch}/${branchMilkTea.branchMilkTeaId.idMilkTea}/${branchMilkTea.branchMilkTeaId.size}">edit</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
