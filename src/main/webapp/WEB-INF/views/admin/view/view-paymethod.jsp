				...
				<div class="card mb-4">
					<ol class="breadcrumb mb-4">
						...
						<li class="breadcrumb-item active"><a
							...
							href="/admin/view-paymethod">Danh sách phương thức thanh toán</a></li>
					</ol>
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i>BẢNG DANH SÁCH PHƯƠNG THỨC THANH
							TOÁN
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<c:forEach var="paymethod" items="${paymethods}">
										<tr>
											<td>${paymethod.idPayMethod}</td>
											<td>${paymethod.name}</td>
											<td><a class="btn btn-success"
												href="/admin/paymethod/edit/${paymethod.idPayMethod}">edit</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
