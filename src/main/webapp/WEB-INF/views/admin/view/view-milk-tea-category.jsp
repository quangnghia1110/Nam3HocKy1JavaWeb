...
<body class="sb-nav-fixed">
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="#">Danh sách danh mục trà sữa</a></li>
                </ol>
                <div class="card mb-4">
                	<div class="card-header">
                            <i class="fas fa-table me-1"></i>DANH SÁCH DANH MỤC TRÀ SỮA
                            ...
                            <tbody>
                                <c:forEach var="category" items="${categories}">
                                    <tr>
                                        ...
                                        <td>${category.name}</td>
                                        <td><a class="btn btn-success" href="/admin/category/edit/${category.idCategory}">edit</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
    ...
    <script>
        function exportToExcel() {
            ...
            XLSX.writeFile(wb, "Danh Sách Danh Mục.xlsx");
        }
        function exportToWord() {
            ...
            a.href = url;
            a.download = 'Danh Sách Danh Mục.doc';
