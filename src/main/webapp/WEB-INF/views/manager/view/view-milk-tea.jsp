...
<link
	...
	rel="stylesheet" />
<link href="<c:url value='/templates/manager/css/styles.css'/>"
	rel="stylesheet" />
							...
							<tbody>
								<c:forEach var="milkTea" items="${milkTeas}">
									<tr>
										...
										<td><c:url
												value="/manager/milk-tea/image/${milkTea.image != null ? milkTea.image : 'uploads/abc.jpg' }"
												var="imgUrl"/> <img width="50px" height="50px"
											src="${imgUrl}"/></td>
										<td><a class="btn btn-success"
											href="/manager/milk-tea/edit/${milkTea.idMilkTea}">edit</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
