            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <ol class="breadcrumb mb-4">
                    	...
                    	<li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/manager/view-order-detail">Danh sách chi tiết đơn hàng</a></li>
                	</ol>
                	<div class="card mb-4">
