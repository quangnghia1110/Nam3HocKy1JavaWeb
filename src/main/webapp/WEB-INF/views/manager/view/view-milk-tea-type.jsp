...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">DANH SÁCH LOẠI TRÀ SỮA</h1>
                <div class="card mb-4">
                    <ol class="breadcrumb mb-4">
                    	<li class="breadcrumb-item"><a style="text-decoration: none" href="/manager/index">Trang chủ</a></li>
                    	<li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/manager/view-milk-tea-type">Danh sách loại trà sữa</a></li>
                	</ol>
                	<div class="card mb-4">
                    	<div class="card-header">
                        	<i class="fas fa-table me-1"></i>BẢNG DANH SÁCH LOẠI TRÀ SỮA
    ...
    <script>
        function exportToExcel() {
            ...
            XLSX.writeFile(wb, "Danh Sách Loại Trà Sữa.xlsx");
        }
        function exportToWord() {
            ...
            a.href = url;
            a.download = 'Danh Sách Loại Trà Sữa.doc';
