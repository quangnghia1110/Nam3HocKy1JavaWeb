...
<body class="sb-nav-fixed">
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/manager/view-customer">Danh sách khách hàng</a></li>
                </ol>
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-table me-1"></i>BẢNG DANH SÁCH KHÁCH HÀNG
    ...
    <script>
        ...
        function exportToWord() {
            ...
            a.href = url;
            a.download = 'Danh Sách Khách Hàng.doc';
