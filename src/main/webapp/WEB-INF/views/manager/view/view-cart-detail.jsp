...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">DANH SÁCH CHI TIẾT ĐƠN HÀNG</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a style="text-decoration: none" href="/manager/index">Trang chủ</a></li>
                    <li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/manager/view-cart-detail">Danh sách chi tiết đơn hàng</a></li>
                </ol>
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-table me-1"></i>BẢNG DANH SÁCH CHI TIẾT ĐƠN HÀNG
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <c:forEach var="cartDetail" items="${cartDetails}">
                                    <tr>
                                        <td>${cartDetail.id_cart}</td>
                                        <td>${cartDetail.id_milk_tea}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
    ...
    <script>
        function exportToExcel() {
            ...
            XLSX.writeFile(wb, "Danh Sách Chi Tiết Đơn Hàng.xlsx");
        }
        ...
        function exportToWord() {
            ...
            a.href = url;
            a.download = 'Danh Sách Chi Tiết Đơn Hàng.doc';
