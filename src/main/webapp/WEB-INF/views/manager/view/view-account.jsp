    ...
    <body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/manager/view-account">Danh sách tài khoản</a></li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i>BẢNG DANH SÁCH TÀI KHOẢN
                                ...
                                <tbody>
                                    <c:forEach var="item" items="${accounts}">
                                        <tr>
                                            ...
                                            <td><a class="btn btn-success" href="/manager/account-update/edit/${item.id_account}">edit</a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
        ...
        <script>
            ...
            function exportToWord() {
                ...
                a.href = url;
                a.download = 'Danh Sách Tài Khoản.doc';
