...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">DANH SÁCH PHƯƠNG THỨC THANH TOÁN</h1>
                <div class="card mb-4">
                    <ol class="breadcrumb mb-4">
                    	<li class="breadcrumb-item"><a style="text-decoration: none" href="/manager/index">Trang chủ</a></li>
                    	<li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/manager/view-paymethod">Danh sách phương thức thanh toán</a></li>
                	</ol>
                	<div class="card mb-4">
                    	<div class="card-header">
                        	<i class="fas fa-table me-1"></i>BẢNG DANH SÁCH PHƯƠNG THỨC THANH TOÁN
    ...
    <script>
        function exportToExcel() {
            ...
            XLSX.writeFile(wb, "Danh Sách Phương Thức Thanh Toán.xlsx");
        }
        function exportToWord() {
            ...
            a.href = url;
            a.download = 'Danh Sách Loại Phương Thức Thanh Toán.doc';
